...
<div class="row">
	...
	?>
		<div class="span3" align="center" style="margin-bottom:10px;">
			...
			?>
			<a href="#myModal-<?php echo $data['id_kandidat']; ?>" role="button" data-toggle="modal" class="btn" type="button"><b>PILIH</b></a>
			<?php } ?>
		</div>
		...
		<div id="myModal-<?php echo $data['id_kandidat']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<h4>ANDA YAKIN?</h4>
				<p>Nama Kandidat : <b><?php echo strtoupper($data['nama_kandidat']);?></b></p>

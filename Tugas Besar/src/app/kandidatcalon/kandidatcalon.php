...
<div class="well">
	...
	if(isset($_POST['update'])){
		...
		if(!empty($_FILES['fupload']['tmp_name'])){
			if (in_array($ekstensi, $extensionList)){
				UploadImages($image);
				if($kandidat->updateDataKandidatFoto($nama_kandidat,$visi,$misi,$image,$id)){ ?>
					<meta http-equiv='refresh' content='0; url=?mod=kandidatcalon'>
					<div class="alert-success alert-block">
				        <button type="button" class="close" data-dismiss="alert">×</button>
				        <h4>Berhasil!</h4>
			...
			if($kandidat->updateDataKandidat($nama_kandidat,$visi,$misi,$id)){ ?>
				<meta http-equiv='refresh' content='0; url=?mod=kandidatcalon'>
				<div class="alert-success alert-block">
			        <button type="button" class="close" data-dismiss="alert">×</button>
			        <h4>Berhasil!</h4>
	...
	<form class="form-horizontal" method="post" id="form" enctype="multipart/form-data">
		<div class="control-group">
			<label class="control-label" for="nama_kandidat">Nama Calon Ketua</label>
			<div class="controls">
		  		<input type="text" class="span3" required maxlength="25" name="nama_kandidat" id="nama_kandidat" value="<?php echo $kandidat->bacaDataKandidat('nama_kandidat', $id); ?>">
...
?>
<div class="well">
    <h3 class="center">DATA HASIL VOTING YANG MASUK</h3>
	<h3 class="center">EVOTING ORG6 Institut Teknologi Sumatera</h3>
	<h4 class="center">MASA PEMILIHAN 2017/2018</h4>
	...
	<h6 class="center"><?php echo $kandidat->bacaDataKandidat('nama_kandidat', $id); ?></h6>
</div>
	...
	<table id="datatable" class="table table-hover table-condensed">
		...
		?>
			<tr>
				...
				<td><?php echo strtoupper($data['nim']);?></td>

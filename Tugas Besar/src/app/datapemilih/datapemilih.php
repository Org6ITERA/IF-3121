...
<div class="well">
	...
	if(isset($_POST['submit'])){
		...
		$nim = $validasi->xss($_POST['nim']);
		$prodi = $validasi->xss($_POST['prodi']);
		$level = 2;

		if($pmlh->tambahDataPemilih($username,$nama,$password,$nim,$prodi,$level)){?>
	...
	<form class="form-horizontal" method="post" id="form">
		...
		<div class="control-group">
			...
			<div class="controls">
		  		<input type="nama" class="span2" required name="nama" id="nama" value="">
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
		  		<input type="text" class="span2" required name="nim" id="nim" value="">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="prodi">PRODI</label>
			<div class="controls">
		  		<input type="text" class="span2" required name="prodi" id="prodi" value="">
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
...
<div class="well">
	...
	if(isset($_POST['update'])){
		...
		if (!empty($_POST['password'])){
			$update = $pmlh->updateDataPemilih($username,$nama,$password,$nim,$prodi,$id);
		}
		else
		{
			$update = $pmlh->updateDataPemilih2($username,$nama,$nim,$prodi,$id);
		}
	...
	<form class="form-horizontal" method="post" id="form">
		...
		<div class="control-group">
			<label class="control-label" for="nama">NAMA</label>
			<div class="controls">
		  		<input type="text" class="span2 uppercase" required name="nama" id="nama" value="<?php echo $pmlh->bacaDataPemilih('nama', $id); ?>">
			</div><input type="text" name="kode" style="display:none;" value="<?php echo $pmlh->bacaDataPemilih('id_login', $id); ?>">
		</div>
		<div class="control-group">
			<label class="control-label" for="password">PASSWORD</label>
		...
		<div class="control-group">
			<label class="control-label" for="nim">NIM</label>
			<div class="controls">
		  		<input type="text" class="span2 uppercase" required name="nim" id="nim" value="<?php echo $pmlh->bacaDataPemilih('nim', $id); ?>">
			</div><input type="text" name="kode" style="display:none;" value="<?php echo $pmlh->bacaDataPemilih('id_login', $id); ?>">
		</div>
		<div class="control-group">
			<label class="control-label" for="prodi">PRODI</label>
			<div class="controls">
		  		<input type="text" class="span2 uppercase" required name="prodi" id="prodi" value="<?php echo $pmlh->bacaDataPemilih('prodi', $id); ?>">
			</div><input type="text" name="kode" style="display:none;" value="<?php echo $pmlh->bacaDataPemilih('id_login', $id); ?>">
		</div>
		<div class="control-group">
			<div class="controls">
